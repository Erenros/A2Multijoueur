...
public:
	...
	// Commands
	bool CommandCreate(std::string exe, std::vector<std::string>& args);
...
private:
	...
	// Make
	bool GenerateVisualSolution(std::string folder, std::unordered_set<std::string>& projects, bool deleteFolder);
	bool GenerateSln();
